...
def get_file_content(file_path: str = None, start_line: int = None, end_line: int = None) -> str:
    """
    ...
    try:
        ...
        formatted_content = "".join(f"{idx}: {line}" for idx, line in zip(range(start, end + 1), selected_lines))
...
def modify_file(file_path: str = None, target_content: str = None, replacement_content: str = None) -> str:
    """
